...
use AppBundle\Entity\Designation;
use AppBundle\Form\DesignationType;
 ...
 * @RouteResource("Designation")
 */
class DesignationRESTController extends VoryxController
{
    /**
     * Get a Designation entity
     *
