 ...
 */
class Version20170622033725 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE countries (id INT AUTO_INCREMENT NOT NULL, iso VARCHAR(2) NOT NULL, name VARCHAR(80) NOT NULL, nicename VARCHAR(80) NOT NULL, iso3 VARCHAR(3) DEFAULT NULL, numcode SMALLINT DEFAULT NULL, phonecode SMALLINT NOT NULL, UNIQUE INDEX UNIQ_5D66EBAD61587F41 (iso), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
