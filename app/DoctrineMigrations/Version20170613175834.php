...
class Version20170613175834 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE comment_like (id BIGINT AUTO_INCREMENT NOT NULL, comment_id BIGINT NOT NULL, liked_by INT NOT NULL, created_at VARCHAR(255) NOT NULL, INDEX IDX_COMMENT_LIKE_COMMENT_ID (comment_id), INDEX IDX_COMMENT_LIKE_LIKED_BY (liked_by), INDEX IDX_COMMENT_LIKE_CREATED_AT (created_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = InnoDB COMMENT = \'stores likes related to a comment\' ');
